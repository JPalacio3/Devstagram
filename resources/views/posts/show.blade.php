...
<div class="container mx-auto md:flex">
    ...
    <div class="md:w-1/2">
        ...
        <form action="{{ route('posts.destroy', $post) }}" method="POST">
            @method('DELETE')
            @csrf
            <input type="submit" value="Eliminar Publicación" class="bg-red-500 hover:bg-red-800 p-2 rounded text-white font-bold mt-4 cursor-pointer" />
        </form>
        @endif
        @endauth
    </div>
    ...
    <div class="md:w-1/2 p-5">
        ...
        <div class="shadow bg-white p-5 mb-5 rounded-xl">
            ...
            {{-- Validar que el usuario esté autenticado para poder comentar e interactuar con la publicación --}}
            @auth
            ...
            <form action="{{ route('comentarios.store', [
                ...
                <div class="mb-5 ">
                    ...
                    <textarea id="comentario" name="comentario" placeholder="Agrega un comentario" class="
                border p-3 w-full rounded-xl
                @error('comentario') border-red-500 bg-red-50 @enderror ">
                    {{ old('comentario') }}
                    </textarea>
                ...
                <input type="submit" value="Comentar" class="
            ...
            <div class="bg-white shadow mb-5 max-h-96 overflow-y-scroll mt-10">
                ...
                <div class="p-5 border-gray-300 border-b text-gray-800">

                    <a href="{{ route('posts.index', $comentario->user) }}" class="font-bold text-xs">
                ...
                @endforeach
                @else
                <p class="p-10 text-center text-gray-500 font-bold">Aún No Hay Comentarios</p>
                @endif
